            ...
            <div className="max-w-screen-2xl mx-auto">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                    {categories.map((cat) => (
                        <div
                            key={cat.name}
                            className="relative w-full aspect-square group overflow-hidden rounded-full"
                        >
                            {/* Image */}
                            <img
                                src={cat.image}
                            ...
                            <div className="absolute inset-0 bg-transparent group-hover:bg-black/50 transition-all duration-500 pointer-events-none" />
