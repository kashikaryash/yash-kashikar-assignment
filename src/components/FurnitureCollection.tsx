    ...
    <section className="bg-[#f9f7f3] px-4 sm:px-8 py-16">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
          {/* Products */}
          <div className="col-span-3 flex overflow-x-auto gap-6 pb-4 scroll-smooth">
            {products.map((item, i) => (
              <div
                key={i}
                className="group min-w-[240px] bg-white rounded-2xl shadow-md hover:shadow-xl transition duration-300"
              >
                {/* Top Icon Bar */}
                ...
                <div className="px-4 pb-4 mt-3">
                  ...
                  <div className="mt-3 max-h-0 opacity-0 group-hover:max-h-40 group-hover:opacity-100 transition-all duration-300 ease-in-out overflow-hidden text-sm text-gray-600">
                    <p className="mt-1 text-xs">
                      Crafted with premium materials, combining elegance and comfort.
                    </p>
                  </div>
                </div>
              </div>
